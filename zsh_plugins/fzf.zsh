...
# export FZF_PREVIEW_COMMAND="bash $HOME/.zsh/file_preview.sh {}"
# export FZF_DEFAULT_OPTS="--height 12 --layout=reverse --history=/home/charles/.zsh/cache/fzfhistory"
export FZF_DEFAULT_OPTS="--preview 'bash ~/.zsh_plugins/file_preview.sh {}' --height 12 --layout=reverse --history=$HOME/.zsh/cache/fzfhistory"
...
zstyle ':fzf-tab:complete:*:*' fzf-preview 'bash ~/.zsh_plugins/file_preview.sh ${(Q)realpath}'
